...
<head>
	...
	<title>Cek Aktivitas Siswa | Sistem Informasi Praktik Kerja Industri</title>
...
<div class="container"> 
  <div class="row">
			...
			<?php echo $this->session->flashdata('msg'); ?><br/>
				...
				<?php $attributes = array("class"=>"form align-items-center","name" => "loginform");
							echo form_open("PantauSiswa/index", $attributes);?>				
					<!--<img class="mb-4" src="../../assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">-->					
					<div class="card-header card-header-primary text-center">
						<h4 class="card-title">Cek Aktivitas Siswa</h4>
