...
<html lang="en">
  <head>
    ...
    <title>Beranda &nbsp|&nbsp Sistem Informasi Prakerin SMK</title>
  ...
  <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="<?php echo site_url('Home/index/');?>">Sistem Informasi Praktik Kerja Industri</a>
